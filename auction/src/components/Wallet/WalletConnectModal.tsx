...
const WalletConnectModal: React.FC = () => {
  ...
  const renderConnectorIcon = useCallback((type: connectorType) => {
    switch (type) {
      case "metamask":
        return <MetamaskIcon height={28} width={28} />;
      case "walletConnect":
        return <WalletConnectIcon height={28} width={28} />;
      case "walletLink":
        return <StyledWalletLinkIcon height={28} width={28} />;
    }
  }, []);
  ...
  return (
    <BasicModal show={show} onClose={onClose} height={294} maxWidth={400} backgroundColor="#424242">
      <BaseContent>
