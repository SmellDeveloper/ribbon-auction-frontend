...
export interface RibbonThetaVaultSTETHInterface extends utils.Interface {
  functions: {
...
export interface RibbonThetaVaultSTETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RibbonThetaVaultSTETHInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      _vaultParams: VaultParamsStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
