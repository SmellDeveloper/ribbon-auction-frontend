...
import type {
  GnosisEasyAuction,
  GnosisEasyAuctionInterface,
} from "../GnosisEasyAuction";
...
export class GnosisEasyAuction__factory {
  static readonly abi = _abi;
  static createInterface(): GnosisEasyAuctionInterface {
    return new utils.Interface(_abi) as GnosisEasyAuctionInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GnosisEasyAuction {
    return new Contract(address, _abi, signerOrProvider) as GnosisEasyAuction;
  }
}
