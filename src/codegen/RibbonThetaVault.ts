...
export interface RibbonThetaVaultInterface extends utils.Interface {
  functions: {
...
export interface RibbonThetaVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RibbonThetaVaultInterface;
